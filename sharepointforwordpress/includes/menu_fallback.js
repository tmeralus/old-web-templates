...
jQuery(document).ready(function(){
	...
	jQuery("ul.children").parent().append("<span></span>"); //Only shows drop down trigger when js is enabled (Adds empty span tag after ul.children*)
	...
	jQuery("div.topnav li span").click(function() { //When trigger is clicked...
